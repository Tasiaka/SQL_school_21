SELECT person.name, menu.pizza_name, menu.price, ROUND((menu.price - (menu.price *  person_discounts.discount/100)),2) AS discount_price, pizzeria.name AS pizzeria_name
